...
class Defaut:
    ...
    def __init__(self, provision_travaux_taux,
        ...
        self._vacance_locative_taux_T1 = vacance_locative_taux_T1
        self._vacance_locative_taux_T2 = vacance_locative_taux_T2
    ...
    @property
    def vacance_locative_taux_T1(self):
        return self._vacance_locative_taux_T1

    @property
    def vacance_locative_taux_T2(self):
        return self._vacance_locative_taux_T2
