...
from analyse_immo.tools.finance import capital_compose, taux_periodique, taux_actuariel
...
class TestTools(unittest.TestCase):
    ...
    def testInteretCompose(self):
        ...
        self.assertAlmostEqual(capital_compose(1000, t_an, 4), 1215.51, 2)
        self.assertAlmostEqual(capital_compose(1000, t_men_actu, 4 * 12), 1215.51, 2)
        self.assertEqual(capital_compose(1000, t_an, 0), 1000)
        self.assertEqual(capital_compose(1000, 0, 4), 1000)
