...
class TestImMir130(unittest.TestCase):
    ...
    def testAll(self):
        ...
        self.assertAlmostEqual(rdt.cashflow_net_annuel(1), 2850, 0)
        ...
        revenu_foncier = (450 + 350 + 300) * 12 - (1000 - 3 * 100)
        revenu_foncier *= .11
        revenu_foncier *= .172
        self.assertAlmostEqual(irpp_0.impots_revenu_foncier, 2937, 0)
        self.assertAlmostEqual(irpp_0.sum_ligne(L9_impot_du), 0, 0)
